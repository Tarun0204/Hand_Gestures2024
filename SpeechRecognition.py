...
def executable(command):
    ...
    if "tell me about" in command or "describe" in command and "yourself":
        print("I am Elite, a voice assistant developed in 2024 by BITS Vizag students. I execute tasks like opening apps, searching, and playing music.")
        speak("I am Elite, a voice assistant developed in 2024 by BITS Vyzaag students. I execute tasks like opening apps, searching, and playing music.")
    elif command=="":
        pass
    ...
    elif "logout" in command or ("logout from" in command and "system" in command):
        speak("Logging out")
